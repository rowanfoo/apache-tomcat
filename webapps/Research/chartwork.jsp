...
<body style="height: 1028px" bgcolor="#E6E6E6">
    <div id="divMain" style="position:relative;width:100%;height:100%">


        <p class="Body"><span class="C-1">Welcome Rowan Chart Research 2</span></p>
  ...
  <div id="container"></div>
     ...
     function addcircle(){
      ...
      <form name=frmTest  action="Research/saveChart" method="post"  onsubmit="myFunction()" >
