...
-->
  ...
  <div style="position: relative;">
   <canvas id="mytext" width="1500" height="815"    style="position: absolute; left: 0; top: 0; z-index: 1;"></canvas>
   <canvas id="tools_sketch" width="1500" height="815" style="position: absolute; left: 0; top: 0; z-index: 0;background:no-repeat center;"></canvas>
              ...
              //    cnvs.moveTo(startPosArr[i].x, startPosArr[i].y);
                ...
                //  cnvs.stroke();
                  ...
                  var action = {
                       ...
                       s.redraw();
                       var canvastext = $('#mytext')[0];
                       var ctxtext = canvastext.getContext('2d');
                       ctxtext.fillText("XX",(startPosArr[i].x), startPosArr[i].y);
              }
...
-->
       <canvas id="mytext"  width="1500" height="815" style="background:no-repeat center;"></canvas>
