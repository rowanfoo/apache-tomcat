...
public class ChartImage {
	...
	public static String year2="&x=0&y=0&time=9&startdate=1%2F4%2F1999&enddate=11%2F24%2F2016&freq=1&compidx=aaaaa%3A0&comptemptext=&comp=none&ma=3&maval=100&uf=0&lf=268435456&lf2=2&lf3=0&type=1&style=320&size=4&timeFrameToggle=false&compareToToggle=false&indicatorsToggle=false&chartStyleToggle=false&state=11";


	
	
	public static ArrayList<String> chartImage( String code )throws Exception{
		System.out.println("chartImage");
		System.out.println("chartImage code "+code);
	
	String href = "<a href=\"JPA/getCharts?code="+code+".AX" ;
	String mode = "&mode=";
	...
	for(String urls : ls){
		...
		image.add(  "<img alt=\"Embedded Image\" src=\""+ imagedata+"\" onclick=\"myFunction(this.src)\"  >" );
