...
<c:if test="${not empty wishlist[code]}">
  ...
  <c:choose>
      <c:when test="${mode == 30}">
     	  <td>      <a href="Charts7.jsp?code=<s:property value="pureCode" />" target="_blank"><font size="3"><s:property value="code" /> </font></a>&nbsp;&nbsp;</td>

      </c:when>
      <c:when test="${mode == 32}">
  <td>     	 <a href="Charts8.jsp?code=<s:property value="pureCode" />" target="_blank"><font size="3"><s:property value="code" /> </font></a>&nbsp;&nbsp;</td>
...
<s:iterator value="modeTable" var="data" >



 	<s:if test="%{key=='mode 29'}">
 		<a href="Charts6.jsp?<s:property value="value" />"> <s:property value="key" /></a>&nbsp;&nbsp
    </s:if>
    <s:elseif test="%{key=='mode 30'}">
		<a href="Charts7.jsp?<s:property value="value" />"> <s:property value="key" /></a>&nbsp;&nbsp
	</s:elseif>
	<s:elseif test="%{key=='mode 32'}">
		<a href="Charts8.jsp?<s:property value="value" />"> <s:property value="key" /></a>&nbsp;&nbsp
	</s:elseif>
	<s:else>
		<a href="Charts5.jsp?<s:property value="value" />"> <s:property value="key" /></a>&nbsp;&nbsp
	</s:else>
