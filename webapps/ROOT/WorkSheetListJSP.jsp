...
<p>     <h2>${error}    </h2></p>
        ...
        <table class="auto-style1" style="width: 100%">
         ...
         %>
         <tr>
           <td><font size="3">code </td>

              <td><font size="3">reason</td>

              <td><font size="3">buy </td>
              <td><font size="3">stop loss </td>

        </tr>
        <c:forEach items="${WorkSheet}"  var="obj">
       <tr>
           <td> <a href="/ChooserWorkSheetJSP?index=<% out.println(count++);%>"  ><font size="3">${obj.code}</font></a> </td>


            <td><font size="3">${obj.reason} </td>

            <td><font size="3">${obj.buy} </td>
            <td><font size="3">${obj.stopLoss} </td>
