  ...
  <div class="container">
    <form action="NewsSearchJSP" method="post">
        <p>Date: <input type="text" id="datepicker" name="MyModeDate">
            ...
            Custom Date<input list="CustomDate" name="CustomDate">
...
<br>
  <h2>${info} </h2>
      ...
      <li class="tab-link" data-tab="tab-10">Presentation </li>
      <li class="tab-link" data-tab="tab-11">Growth </li>
      <li class="tab-link" data-tab="tab-12">New  </li>
      <li class="tab-link" data-tab="tab-13">Feasibility  </li>
      <li class="tab-link" data-tab="tab-14">Acquisition  </li>
      ...
      <%
System.out.println("Loop ww1");
      %>

<table class="auto-style1" style="width: 100%">
  <%
System.out.println("Loop ww2");
  %>
  ...
  <c:forEach items="${Director}"  var="obj">
    ...
    <a href="Charts.jsp?${DirectorC}">All Charts </a>&nbsp;&nbsp;
  	</div>
</div>
    ...
    <div id="tab-2" class="tab-content">
      <table class="auto-style1" style="width: 100%">
        ...
        <td> <a href="${obj.link}" target="_blank"><font size="3">${obj.title}</font></a></td>
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${WebcastC}">All Charts </a>&nbsp;&nbsp;
        	</div>
      ...
      <%
    System.out.println("Loop ww2.1");
      %>

    	<div id="tab-3" class="tab-content">
        <%
      System.out.println("Loop ww2.2");
        %>
        <table class="auto-style1" style="width: 100%">
        <c:forEach items="${Briefing}"  var="obj">
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${BriefingC}">All Charts </a>&nbsp;&nbsp;
          </div>
        ...
        <c:forEach items="${boardroom}"  var="obj">
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${boardroomC}">All Charts </a>&nbsp;&nbsp;
          </div>
      ...
      <div id="tab-5" class="tab-content">
        ...
        <c:forEach items="${teleconference}"  var="obj">
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${updateC}">All Charts </a>&nbsp;&nbsp;
          </div>
      ...
      <div id="tab-8" class="tab-content">
        ...
        <c:forEach items="${conference}"  var="obj">
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${conferenceC}">All Charts </a>&nbsp;&nbsp;
          </div>
      ...
      <div id="tab-9" class="tab-content">
        ...
        <c:forEach items="${management}"  var="obj">
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${managementC}">All Charts </a>&nbsp;&nbsp;
          </div>
      ...
      <div id="tab-10" class="tab-content">
        ...
        <c:forEach items="${Presentation}"  var="obj">
          <tr>
            <td> <a href="http://bigcharts.marketwatch.com/advchart/frames/frames.asp?show=&insttype=Stock&symb=au%3A${obj.code}&x=56&y=11&time=10&startdate=1%2F4%2F1999&enddate=8%2F2%2F2016&freq=2&compidx=aaaaa%3A0&comptemptext=&comp=none&ma=1&maval=12&uf=0&lf=268435456&lf2=0&lf3=0&type=1&style=320&size=4&timeFrameToggle=false&compareToToggle=false&indicatorsToggle=false&chartStyleToggle=false&state=11"  ><font size="3">${obj.code}</font></a> </td>
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${PresentationC}">All Charts </a>&nbsp;&nbsp;
          </div>
      ...
      <div id="tab-11" class="tab-content">
        ...
        <c:forEach items="${Growth}"  var="obj">
          <tr>
            <td> <a href="http://bigcharts.marketwatch.com/advchart/frames/frames.asp?show=&insttype=Stock&symb=au%3A${obj.code}&x=56&y=11&time=10&startdate=1%2F4%2F1999&enddate=8%2F2%2F2016&freq=2&compidx=aaaaa%3A0&comptemptext=&comp=none&ma=1&maval=12&uf=0&lf=268435456&lf2=0&lf3=0&type=1&style=320&size=4&timeFrameToggle=false&compareToToggle=false&indicatorsToggle=false&chartStyleToggle=false&state=11"  ><font size="3">${obj.code}</font></a> </td>
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${GrowthC}">All Charts </a>&nbsp;&nbsp;
          </div>
      ...
      <div id="tab-12" class="tab-content">
        ...
        <c:forEach items="${New}"  var="obj">
          ...
          <div style="text-align: center">
          <a href="Charts.jsp?${NewC}">All Charts </a>&nbsp;&nbsp;
          </div>
...
<div id="tab-12" class="tab-content">
  ...
  <c:forEach items="${Feasibility}"  var="obj">
    <tr>
      <td> <a href="http://bigcharts.marketwatch.com/advchart/frames/frames.asp?show=&insttype=Stock&symb=au%3A${obj.code}&x=56&y=11&time=10&startdate=1%2F4%2F1999&enddate=8%2F2%2F2016&freq=2&compidx=aaaaa%3A0&comptemptext=&comp=none&ma=1&maval=12&uf=0&lf=268435456&lf2=0&lf3=0&type=1&style=320&size=4&timeFrameToggle=false&compareToToggle=false&indicatorsToggle=false&chartStyleToggle=false&state=11"  ><font size="3">${obj.code}</font></a> </td>
    ...
    <div style="text-align: center">
    <a href="Charts.jsp?${FeasibilityC}">All Charts </a>&nbsp;&nbsp;
    </div>
...
<div id="tab-13" class="tab-content">
  ...
  <c:forEach items="${Acquisition}"  var="obj">
    <tr>
      <td> <a href="http://bigcharts.marketwatch.com/advchart/frames/frames.asp?show=&insttype=Stock&symb=au%3A${obj.code}&x=56&y=11&time=10&startdate=1%2F4%2F1999&enddate=8%2F2%2F2016&freq=2&compidx=aaaaa%3A0&comptemptext=&comp=none&ma=1&maval=12&uf=0&lf=268435456&lf2=0&lf3=0&type=1&style=320&size=4&timeFrameToggle=false&compareToToggle=false&indicatorsToggle=false&chartStyleToggle=false&state=11"  ><font size="3">${obj.code}</font></a> </td>
